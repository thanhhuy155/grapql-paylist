...
public class AppiumController {
    ...
    public void start() throws MalformedURLException {
        ...
        String androidBuild = "Android_V4.3.0_RegressionTestForSprintN_"+formater2.format(calendar.getTime());
...
//        String iOSBuild = "iOSLocalTestBuild";
        String iOSBuild = "iOS_V4.3.1_RegressionTestForSprintN_"+formater2.format(calendar.getTime());
